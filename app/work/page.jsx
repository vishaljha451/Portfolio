...
const projects = [
  {
    ...
    title: "project 1",
    description:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum quo accusantium quod rem et quaerat",
...
const Work = () => {
  ...
  return (
    <motion.div
      ...
      className="min-h-[80vh] flex flex-col justify-container py-12 xl:px-0"
    >
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row xl:gap-[30px]">
          <div className="w-full xl:w-[50%] xl:h-[460px] flex flex-col xl:justify-between order-2 xl:order-none">
            ...
            <div className="bordeer border-white/20"></div>
          ...
          <div className="w-full xl:w-[50%]">
            ...
            >
              ...
              <WorkSliderBtns
                conatinerStyles="flex gap-2 absolute right-0
              bottom-[calc(50%_-_22px)] xl:bottom-0 z-20 w-full
              justify-between xl:w-max xl:justify-none"
                btnStyles="bg-cyan-500 hover:bg-cyan-500-hover text-primary text-[22px] w-[44px] h-[44px] flex justify-center items-center transition-all"
              />
            </Swiper>
          </div>
        </div>
